...
//
//   const rESTCountryResource = Convert.toRESTCountryResource(json);
//
...
export class Convert {
    public static toRESTCountryResource(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RESTCountryResource")));
    }

    public static rESTCountryResourceToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RESTCountryResource"))), null, 2);
    }
}
